...
y_data = [] 
for p in list_ppm:
    y_data.append(np.log(p))#natural logarithm of p

print(np.polynomial.polynomial.Polynomial.fit(x_data, y_data, 1))
print(np.polyfit(x_data, y_data,1))

x = np.linspace(0,10000,10000) #le temps
y = 1.15512874e-04 + 6.75295297e+00*x 

# plot the function
plt.plot(x,y, 'r')
plt.scatter(x_data,list_ppm, s = 1)
# show the plot
plt.ylim(0,3000)
