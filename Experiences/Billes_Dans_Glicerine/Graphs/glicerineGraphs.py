...
while t != ():
    ...
    if len(temps_billes1) == 1:
        x0,y0,x1,y1 = [0,0,x_dis, y_dis]
        temps_ecoule = temps_billes1[-1]
        vitesse_billes1.append( calculVitesse(temps_ecoule, calculDistance2D(0,0, x_dis, y_dis) ) )
    else:
        x0, y0 = xy_billes1[-2]
        x1,y1 = [x_dis,y_dis]
        temps_ecoule = temps_billes1[-1] - temps_billes1[-2]
        vitesse_billes1.append( calculVitesse(temps_ecoule, calculDistance2D(x0, y0, x_dis, y_dis) ) )
    err_vitesse_billes1.append(incertitudeCalculVitesse(temps_ecoule, x0,y0,x1,y1))
    t = readtuple(file)
...
while t != ():
    ...
    if len(temps_billes2) == 1:
        x0,y0,x1,y1 = [0,0,x_dis, y_dis]
        temps_ecoule = temps_billes2[-1] + 0.000001                          #      v  otherwise it divides by 0
        vitesse_billes2.append( calculVitesse(temps_billes2[-1]+0.0000001, calculDistance2D(0,0, x_dis, y_dis) ) )
    else:
        x0, y0 = xy_billes2[-2]
        x1,y1 = [x_dis,y_dis]
        temps_ecoule = temps_billes2[-1] - temps_billes2[-2]
        vitesse_billes2.append( calculVitesse(temps_billes2[-1] - temps_billes2[-2], calculDistance2D(x0, y0, x_dis, y_dis) ) )
    err_vitesse_billes2.append( incertitudeCalculVitesse(temps_ecoule, x0,y0,x1,y1))
    t = readtuple(file)
...
while t != ():
    ...
    if len(temps_billes4) == 1:
        x0,y0,x1,y1 = [0,0,x_dis, y_dis]
        temps_ecoule = temps_billes4[-1] + 0.000001                          #      v  otherwise it divides by 0
        vitesse_billes4.append( calculVitesse(temps_billes4[-1]+0.0000001, calculDistance2D(0,0, x_dis, y_dis) ) )
    else:
        x0, y0 = xy_billes4[-2]
        x1,y1 = [x_dis,y_dis]
        temps_ecoule = temps_billes4[-1] - temps_billes4[-2]
        vitesse_billes4.append( calculVitesse(temps_billes4[-1] - temps_billes4[-2], calculDistance2D(x0, y0, x_dis, y_dis) ) )
    err_vitesse_billes4.append( incertitudeCalculVitesse(temps_ecoule, x0,y0,x1,y1))
    t = readtuple(file)

#pour les erreurs on a 0.005cm pour la hauteur totale et +- 1/60 seconde car on a filme a 30 fps et lincertitude est la moitie de ca 
...
plt.errorbar(temps_billes1, vitesse_billes1, yerr = err_vitesse_billes1, fmt='.k', elinewidth=1 )
plt.xlabel("Temps(s)")
...
plt.errorbar(temps_billes2, vitesse_billes2, yerr = err_vitesse_billes2, fmt='.k', elinewidth=1 )
plt.xlabel("Temps(s)")
plt.ylabel("Vitesse (m/s)")
plt.title("billes2")
...
plt.subplot(413)
#plt.scatter(temps_billes2, vitesse_billes2)
plt.errorbar(temps_billes3, vitesse_billes3, yerr = err_vitesse_billes3, fmt='.k', elinewidth=1 )
plt.xlabel("Temps(s)")
plt.ylabel("Vitesse (m/s)")
plt.title("billes3")
...
plt.subplot(414)
#plt.scatter(temps_billes2, vitesse_billes2)
plt.errorbar(temps_billes4, vitesse_billes4, yerr = err_vitesse_billes4, fmt='.k', elinewidth=1 )
plt.xlabel("Temps(s)")
plt.ylabel("Vitesse (m/s)")
plt.title("billes4")
"""
...
"""
temps_billes, vitesse_billes, err_vitesse_billes = doneesPourGraphs("billes3.txt")
print(vitesse_billes)
print(len(vitesse_billes))
"""
"""
plt.subplot(413)
#plt.scatter(temps_billes2, vitesse_billes2)
...
"""
"""
temps_billes1, vitesse_billes1, err_vitesse_billes1 = doneesPourGraphs("billes1.txt")
temps_billes2, vitesse_billes2, err_vitesse_billes2 = doneesPourGraphs("billes2.txt")
temps_billes3, vitesse_billes3, err_vitesse_billes3 = doneesPourGraphs("billes3.txt")
temps_billes4, vitesse_billes4, err_vitesse_billes4 = doneesPourGraphs("billes4.txt")
"""

"""
temps_billes, vitesse_billes, err_vitesse_billes = doneesPourGraphs("billes1.txt")
...
temps_billes, vitesse_billes, err_vitesse_billes = doneesPourGraphs("billes2.txt")
...
temps_billes, vitesse_billes, err_vitesse_billes = doneesPourGraphs("billes4.txt")
